...
export default function Hero() {
  return (
    <section className="pt-24 md:pt-32 pb-16 md:pb-20 bg-gradient-to-br from-blue-50 via-white to-green-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Badge d'alerte */}
          <motion.div
            className="inline-block bg-red-100 text-red-700 px-4 py-2 rounded-full text-sm md:text-base font-semibold mb-6"
          ...
          {/* Titre principal - TAILLES RÉTABLIES */}
